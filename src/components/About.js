...
export default function About() {
    ...
    if(!author) return <div className="cursive text-5xl" style={{textAlign: "center", marginTop: "300px"}}>Loading...</div>
    return (
                ...
                <section className="bg-green-800 rounded-lg shadow-2xl lg:flex p-20">
                    ...
                    <div className="text-lg flex flex-col justify-center">
                        ...
                        <div className="prose lg:prose-xl text-white">
                            <BlockContent blocks={author.bio} projectId="hrjksl12" dataset="production"/>
                        </div>
                    </div>
                </section>
            </div>
